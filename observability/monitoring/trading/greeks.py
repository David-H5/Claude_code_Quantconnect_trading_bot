"""
Greeks Risk Monitor (CANONICAL LOCATION)
...
Location: observability/monitoring/trading/greeks.py
Import: from observability.monitoring.trading import GreeksMonitor
