"""
Correlation Monitor (CANONICAL LOCATION)

Monitors position correlations and concentration risk.
Tracks rolling correlations and alerts on high concentration.

Location: observability/monitoring/trading/correlation.py
Import: from observability.monitoring.trading import CorrelationMonitor
